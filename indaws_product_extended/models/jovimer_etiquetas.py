...
class JovimerEtiquetas(models.Model):
    ...
    content_uom = fields.Html(string='Contenido Etiqueta HTML')
    ...
    dossier_campaign = fields.Selection('jovimer.expedientes', related='expediente.campanya')
    dossier_series_id = fields.Many2one('jovimer.expedientes.series', related='expediente.serie')
    dossier_num = fields.Integer('jovimer.expedientes', related='expediente.name')
