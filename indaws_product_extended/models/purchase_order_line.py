...
class ModelSaleOrderLine(models.Model):
    ...
    expediente_serien = fields.Many2one('jovimer.expedientes.series', related='expediente.series_id', store=True)
    ...
    expediente_serieno = fields.Many2one('jovimer.expedientes.series', related='expediente.series_id', store=True)
